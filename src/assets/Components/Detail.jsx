 ...
 <Herosection />
    ...
    <div className="flex flex-row px-60 ">
      <div className="w-full md:w-[410px]">
        <img src={filterItem.Img} alt="loading....." className="w-[90%] object-cover" />
      </div>

      <div className="w-full md:w-1/2 flex flex-col gap-4  md:gap-6 p-4 md:p-6 ">
        <div className="mb-1-">
          <h1 className="text-4xl font-bold text-gray-800">{filterItem.title}</h1>
          <p className="text-2xl text-gray-600 mt-4">{filterItem.price}</p>
